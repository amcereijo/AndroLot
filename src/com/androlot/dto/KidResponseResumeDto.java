...
public class KidResponseResumeDto extends RespuestaResumenDto {
	...
	private String[] extracciones5cifras = new String[0];//:	terceros array con las 12 extracciones de 5 cifras o -1 si aún no ha salido.
	
	private String[] extracciones3cifras = new String[0]; //	array con las 14 extracciones de 3 cifras o -1 si aún no ha salido.
	private String[] extracciones2cifras = new String[0]; //:	array con las 5 extracciones de 2 cifras o -1 si aún no ha salido.
	private String[] reintegros = new String[0]; //:	array con los 3 reintegros (2 extracciones especiales + última cifra del 1er. premio) o -1 si aún no ha salido.
